...
var newLinkURL = function newLinkURL(linkNode, destinationDir) {
  if (destinationDir) {
  ...
  var visitor = function visitor(link) {
    if (isRelativeUrl(link.url) && getNode(markdownNode.parent).internal.type === `File`) {
      ...
      if (linkNode && linkNode.absolutePath) {
        ...
        var linkURL = newLinkURL(linkNode, options.destinationDir);
        link.url = linkURL;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              ...
              console.error(`error copy ing file`, _context.t0);
