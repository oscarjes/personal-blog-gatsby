      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            report.error(`Failed to process image ${file.absolutePath}`, _context2.t0);
...
var responsiveSizes = function () {
  var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(_ref8) {
    ...
    var defaultArgs, options, metadata, _metadata, width, height, density, pixelRatio, presentationWidth, presentationHeight, sizes, filteredSizes, sortedSizes, images, base64Width, base64Height, base64Args, base64Image, originalImg, fallbackSrc, srcSet, originalName;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 10:
            ...
            report.error(`Failed to process image ${file.absolutePath}`, _context4.t0);
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 11:
            ...
            report.error(`Failed to process image ${file.absolutePath}`, _context6.t0);
